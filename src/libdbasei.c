...
unsigned const char _STAT[2][81] = {
  // first status msg 0-79
  {
    [1]=0xbd,  [3]=0x0c,  [6]=0x30,  [7]=0x20,  [8]=0x03,  [13]=0x0a,
    [18]=0xb5, [19]=0xa9, [21]=0xb0, [22]=0x1e,
    [41]=0xff, [42]=0x03, [43]=0x58, [44]=0x02,
    [57]=0xfa, [58]=0x01, [59]=0xd5, [60]=0x01, [61]=0xb0, [62]=0x01,                       // toggle
    [66]=0x80, [67]=0xfa, [68]=0x01, [69]=0xd5, [70]=0x01, [71]=0xb0, [72]=0x01, [73]=0x40, [77]=0x10, [79]=0x2e,
    [80]=0x0b
  },
  // second status msg 80-159
  {
    [1]=0x3d,  [3]=0x0c,  [6]=0x30,  [7]=0x20,  [8]=0x03,  [13]=0x0a,
    [18]=0xb5, [19]=0x29, [21]=0xb0, [22]=0x1e,
    [41]=0xff, [42]=0x03, [43]=0x58, [44]=0x02,
    [57]=0xfa, [58]=0x01, [59]=0xd5, [60]=0x01, [61]=0xb0, [62]=0x01,
    [67]=0xfa, [68]=0x01, [69]=0xd5, [70]=0x01, [71]=0xb0, [72]=0x01, [73]=0x40, [79]=0x2e,
    [80]=0x0b
  }
};
...
int dbase_init2(libusb_device_handle *dev){
  ...
  */
  ...
  for(k = 0; k <= 4; k++) 
	...
	if(_DEBUG) printf("clearing ltp/rtp in ctrl byte\n");
...
unsigned char* dbase_get_firmware_pack(const char* file, int n, int *len)
{
  ...
  if(fh == NULL){
    fprintf(stderr, 
	    "E: dbase_get_firmware_pack() Unable to open digiBase.rbf file; %s (%s)\n%s\n", 
	    file, 
	    strerror(errno),
