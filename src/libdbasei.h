...
#ifndef __LIBDBASEI_H__
#define __LIBDBASEI_H__
...
*/
#define EP_IN (2 | LIBUSB_ENDPOINT_IN)   /* Can also be 1 */
#define EP_OUT (2 | LIBUSB_ENDPOINT_OUT) /* Can also be 1 */
...
/*
   Get firmware from digiBase.rbf
*/
